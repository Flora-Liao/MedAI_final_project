...
# 設定資料路徑
input_dir = "BUSI-Yolov8/images/train"
label_dir = "BUSI-Yolov8/labels/train"
out_img_dir = "BUSI-aug-only2/images/train"
out_lbl_dir = "BUSI-aug-only2/labels/train"

# 建立輸出資料夾
os.makedirs(out_img_dir, exist_ok=True)
os.makedirs(out_lbl_dir, exist_ok=True)

# Albumentations 資料增強設定（無 CLAHE）
cfg = {
    "rotation": 10,
    "h_flip": True,
    "crop_resize": 0.8,
...
for img_path in tqdm(image_paths):
    ...
    # === Albumentations 增強後圖與標註（無 CLAHE） ===
    augmented = tfms(image=img, bboxes=bboxes, class_labels=class_ids)
